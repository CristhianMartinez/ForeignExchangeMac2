namespace ForeignExchangeMac2.ViewModels
{
    ...
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        async void Convert()
        {
			...
			{
                await Application.Current.MainPage.DisplayAlert("Error", "You must enter a value in Pesos", "Acept");
				return;
			}
			...
			{
				await Application.Current.MainPage.DisplayAlert("Error", "You must enter a value numeric in Pesos", "Acept");
				Pesos = null;
				return;
			}
